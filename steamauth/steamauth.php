...
function logoutbutton() {
    echo "<form action=\"steamauth/logout.php\" method=\"post\"><input value=\"logout\" type=\"submit\" id=\"logoutButton\" class=\"button\"/></form>"; //logout button
}
...
try {
    ...
    return "<form id=\"loginButton\" action=\"?login\" method=\"post\"> <input type=\"image\" src=\"http://cdn.steamcommunity.com/public/images/signinthroughsteam/sits_".$button.".png\"></form>";
    }
